...
function CategoriesStats({
  ...
  const formatter = useMemo(
    () => GteFormatterForCurrency(userSettings.currency),
...
export function CategoriesCard({
  ...
  return (
    <Card className="h-80 w-full">
      <CardHeader>
        <CardTitle className="grid grid-flow-row justify-between gap-2 to-muted-foreground md:grid-flow-col"></CardTitle>
      </CardHeader>
        ...
        {filteredData.length === 0 && (
          <div className="flex h-60 w-full flex-col items-center justify-center">
            ...
            <p className="text-sm text-muted-foreground">
              Try select a different period or try adding new
                ...
                return (
                  <div key={item.category} className="flex flex-col gap-2">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="to-gray-400 text-sm">
